    ...
    <div className="flex gap-1">
      <div className="relative">
        <button
          ...
          title="Undo"
          className={`flex items-center justify-center w-9 h-9 rounded-lg border border-slate-300 bg-white cursor-pointer text-slate-600 text-[1rem] transition-colors duration-150 ${canUndo ? 'hover:bg-slate-100' : 'opacity-40 cursor-not-allowed'}`}
          onClick={onUndo}
          disabled={!canUndo}
      ...
      <div className="relative">
        <button
          ...
          title="Redo"
          className={`flex items-center justify-center w-9 h-9 rounded-lg border border-slate-300 bg-white cursor-pointer text-slate-600 text-[1rem] transition-colors duration-150 ${canRedo ? 'hover:bg-slate-100' : 'opacity-40 cursor-not-allowed'}`}
          onClick={onRedo}
          disabled={!canRedo}
