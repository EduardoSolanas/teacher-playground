...
export function LibraryPanel({ visible, onClose }: LibraryPanelProps) {
  ...
  return (
    ...
    >
      <div
        className="w-[90%] max-w-[26.25rem] rounded-xl border border-slate-700 bg-slate-800 p-5 text-slate-200 shadow-2xl"
      ...
      >
        <div className="mb-4 flex items-center justify-between">
          ...
          <button
            ...
            type="button"
            onClick={onClose}
            className="cursor-pointer border-none bg-transparent px-2 text-[1.25rem] text-slate-400 hover:text-slate-100"
          >
            &times;
          </button>
        </div>
